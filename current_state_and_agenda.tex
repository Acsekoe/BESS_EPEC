...
\small
\begin{itemize}
    \item Upward activation injects energy into the node; downward activation absorbs energy from the node.
    \item Therefore, aFRR activation directly affects the LMP-forming balance instead of remaining a pure capacity payment.
\end{itemize}
